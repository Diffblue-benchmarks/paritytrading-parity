...
class TAQWriterDiffblueTest {
   ...
   *   <li>Then calls {@link TAQConfig#getEncoding()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TAQWriter#TAQWriter(OutputStream, TAQConfig)}
   */
  @Test
  @DisplayName("Test new TAQWriter(OutputStream, TAQConfig); given forName 'UTF-8'; then calls getEncoding()")
