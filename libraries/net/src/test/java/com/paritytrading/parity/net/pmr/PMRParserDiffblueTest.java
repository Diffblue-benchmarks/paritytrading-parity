...
class PMRParserDiffblueTest {
  ...
  void testMessage() throws IOException {
    // Arrange
    PMRListener listener = mock(PMRListener.class);
    doThrow(new PMRException("An error occurred"))
        .when(listener)
        .orderAdded(Mockito.<OrderAdded>any());
   ...
   *
   * <ul>
   *   <li>Given {@link PMRListener} {@link PMRListener#version(Version)} throw {@link
   *       PMRException#PMRException(String)} with message is {@code An error occurred}.
   * </ul>
   *
   * <p>Method under test: {@link PMRParser#message(ByteBuffer)}
   */
  @Test
  @DisplayName(
      "Test message(ByteBuffer); given PMRListener version(Version) throw PMRException(String) with message is 'An error occurred'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PMRParser.message(ByteBuffer)"})
  void testMessage_givenPMRListenerVersionThrowPMRExceptionWithMessageIsAnErrorOccurred()
      throws IOException {
    // Arrange
    PMRListener listener = mock(PMRListener.class);
    doThrow(new PMRException("An error occurred")).when(listener).version(Mockito.<Version>any());
    PMRParser pmrParser = new PMRParser(listener);

    // Act and Assert
    assertThrows(
        PMRException.class, () -> pmrParser.message(ByteBuffer.wrap("VXAXAXAX".getBytes("UTF-8"))));
    verify(listener).version(isA(Version.class));
  }
  ...
  @Test
  @DisplayName(
      "Test message(ByteBuffer); then wrap array of byte with 'A' and one position is seventeen")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PMRParser.message(ByteBuffer)"})
   ...
   *   <li>Then throw {@link PMRException}.
   * </ul>
   *
   * <p>Method under test: {@link PMRParser#message(ByteBuffer)}
   */
  @Test
  @DisplayName(
      "Test message(ByteBuffer); when wrap 'AXAXAXAX' Bytes is 'UTF-8'; then throw PMRException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PMRParser.message(ByteBuffer)"})
  void testMessage_whenWrapAxaxaxaxBytesIsUtf8_thenThrowPMRException() throws IOException {
    ...
    // Act and Assert
    assertThrows(
        PMRException.class, () -> pmrParser.message(ByteBuffer.wrap("AXAXAXAX".getBytes("UTF-8"))));
  }
  ...
  @Test
  @DisplayName(
      "Test message(ByteBuffer); when wrap 'EXAXAXAX' Bytes is 'UTF-8'; then throw PMRException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PMRParser.message(ByteBuffer)"})
  void testMessage_whenWrapExaxaxaxBytesIsUtf8_thenThrowPMRException() throws IOException {
    ...
    // Act and Assert
    assertThrows(
        PMRException.class, () -> pmrParser.message(ByteBuffer.wrap("EXAXAXAX".getBytes("UTF-8"))));
  }
   ...
   *
   * <ul>
   *   <li>When wrap {@code TXAXAXAX} Bytes is {@code UTF-8}.
   *   <li>Then throw {@link PMRException}.
   * </ul>
   *
   * <p>Method under test: {@link PMRParser#message(ByteBuffer)}
  ...
  @Test
  @DisplayName(
      "Test message(ByteBuffer); when wrap 'TXAXAXAX' Bytes is 'UTF-8'; then throw PMRException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PMRParser.message(ByteBuffer)"})
  void testMessage_whenWrapTxaxaxaxBytesIsUtf8_thenThrowPMRException() throws IOException {
    ...
    // Act and Assert
    assertThrows(
        PMRException.class, () -> pmrParser.message(ByteBuffer.wrap("TXAXAXAX".getBytes("UTF-8"))));
  }
  ...
  @Test
  @DisplayName(
      "Test message(ByteBuffer); when wrap 'XXAXAXAX' Bytes is 'UTF-8'; then throw PMRException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void PMRParser.message(ByteBuffer)"})
  void testMessage_whenWrapXxaxaxaxBytesIsUtf8_thenThrowPMRException() throws IOException {
    ...
    // Act and Assert
    assertThrows(
        PMRException.class, () -> pmrParser.message(ByteBuffer.wrap("XXAXAXAX".getBytes("UTF-8"))));
  }
