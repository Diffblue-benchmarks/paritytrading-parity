...
public class PMDTestFactory {

    @InterestingTestFactory
    public static ByteBuffer createByteBufferForOrderAddedGet() {
        return ByteBuffer.allocate(41);
    }

    @InterestingTestFactory
    public static ByteBuffer createByteBufferForOrderAddedPut() {
