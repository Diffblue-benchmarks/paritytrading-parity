...
class PMDParserDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test new PMDParser(PMDListener); then wrap 'VXAXAXAX' Bytes is 'UTF-8' position is five")
   ...
   * <ul>
   *   <li>Given {@link PMDListener} {@link PMDListener#version(Version)} throw {@link PMDException#PMDException(String)} with message is {@code An error occurred}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PMDParser#message(ByteBuffer)}
   */
  @Test
  @DisplayName("Test message(ByteBuffer); given PMDListener version(Version) throw PMDException(String) with message is 'An error occurred'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PMDParser.message(ByteBuffer)"})
  void testMessage_givenPMDListenerVersionThrowPMDExceptionWithMessageIsAnErrorOccurred() throws IOException {
    // Arrange
    PMDListener listener = mock(PMDListener.class);
   ...
   * <ul>
   *   <li>When {@code A}.</li>
   *   <li>Then throw {@link PMDException}.</li>
   * </ul>
   * <p>
   * Method under test: {@link PMDParser#message(ByteBuffer)}
   */
   ...
   */
  @Test
  @DisplayName("Test message(ByteBuffer); when wrap 'AXAXAXAX' Bytes is 'UTF-8'; then throw PMDException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PMDParser.message(ByteBuffer)"})
   ...
   */
  @Test
  @DisplayName("Test message(ByteBuffer); when wrap 'EXAXAXAX' Bytes is 'UTF-8'; then throw PMDException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PMDParser.message(ByteBuffer)"})
   ...
   */
  @Test
  @DisplayName("Test message(ByteBuffer); when wrap 'XXAXAXAX' Bytes is 'UTF-8'; then throw PMDException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PMDParser.message(ByteBuffer)"})
