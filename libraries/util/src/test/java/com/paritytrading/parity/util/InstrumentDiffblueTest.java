...
class InstrumentDiffblueTest {
  ...
  @MethodsUnderTest({"long Instrument.asLong()", "String Instrument.asString()", "String Instrument.getPriceFormat()",
      "int Instrument.getPriceFractionDigits()", "String Instrument.getSizeFormat()",
   ...
   * <ul>
   *   <li>Then fromConfig {@link Config} and {@code Path} PriceFormat is {@code %1.0f}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Instrument#setPriceFormat(int, int)}
   */
  @Test
  @DisplayName("Test setPriceFormat(int, int); then fromConfig Config and 'Path' PriceFormat is '%1.0f'")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link Instrument#setPriceFormat(int, int)}.
   * <ul>
   *   <li>Then fromConfig {@link Config} and {@code Path} PriceFormat is {@code %3.1f}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Instrument#setPriceFormat(int, int)}
   */
  @Test
  @DisplayName("Test setPriceFormat(int, int); then fromConfig Config and 'Path' PriceFormat is '%3.1f'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Instrument.setPriceFormat(int, int)"})
   ...
   * <ul>
   *   <li>Then fromConfig {@link Config} and {@code Path} SizeFormat is {@code %1.0f}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Instrument#setSizeFormat(int, int)}
   */
  @Test
  @DisplayName("Test setSizeFormat(int, int); then fromConfig Config and 'Path' SizeFormat is '%1.0f'")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link Instrument#setSizeFormat(int, int)}.
   * <ul>
   *   <li>Then fromConfig {@link Config} and {@code Path} SizeFormat is {@code %3.1f}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Instrument#setSizeFormat(int, int)}
   */
  @Test
  @DisplayName("Test setSizeFormat(int, int); then fromConfig Config and 'Path' SizeFormat is '%3.1f'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Instrument.setSizeFormat(int, int)"})
   ...
   */
  @Test
  @DisplayName("Test fromConfig(Config, String); given one; when Config getInt(String) return one; then return PriceFormat is '%3.1f'")
  @Tag("MaintainedByDiffblue")
   ...
   *   <li>Then return PriceFormat is {@code %1.0f}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Instrument#fromConfig(Config, String)}
   */
  @Test
  @DisplayName("Test fromConfig(Config, String); given zero; when Config getInt(String) return zero; then return PriceFormat is '%1.0f'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Instrument Instrument.fromConfig(Config, String)"})
