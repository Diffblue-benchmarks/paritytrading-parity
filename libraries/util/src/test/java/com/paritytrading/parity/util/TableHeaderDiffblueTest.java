...
class TableHeaderDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link TableHeader} (default constructor) add {@code .} and two.</li>
   ...
   */
  @Test
  @DisplayName("Test format(); given TableHeader (default constructor) add '.' and two; then return '. N -- -'")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link TableHeader#format()}.
   * <ul>
   *   <li>Given {@link TableHeader} (default constructor) add {@code Name} and one.</li>
   *   <li>Then return {@code N -}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TableHeader#format()}
   */
  @Test
  @DisplayName("Test format(); given TableHeader (default constructor) add 'Name' and one; then return 'N -'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String TableHeader.format()"})
   ...
   * Test {@link TableHeader#format()}.
   * <ul>
   *   <li>Given {@link TableHeader} (default constructor).</li>
