...
class MarketDataProcessorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link MarketDataProcessor#orderExecuted(PMD.OrderExecuted)}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link MarketDataProcessor#orderCanceled(OrderCanceled)}
   */
  @Test
  @DisplayName("Test orderCanceled(OrderCanceled); then calls getPricePlaceholder()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MarketDataProcessor.orderCanceled(OrderCanceled)"})
