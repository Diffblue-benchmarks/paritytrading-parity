...
class TAQFormatDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Instrument} {@link Instrument#getSizeFactor()} return {@code -0.5}.</li>
   *   <li>Then calls {@link OrderBook#getAskSize(long)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TAQFormat#update(OrderBook, boolean)}
   */
  @Test
  @DisplayName("Test update(OrderBook, boolean); given Instrument getSizeFactor() return '-0.5'; then calls getAskSize(long)")
  @Tag("MaintainedByDiffblue")
   ...
   * Test {@link TAQFormat#update(OrderBook, boolean)}.
   * <ul>
   *   <li>Given {@link Instrument} {@link Instrument#getSizeFactor()} return ten.</li>
   *   <li>Then calls {@link OrderBook#getAskSize(long)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TAQFormat#update(OrderBook, boolean)}
   */
  @Test
  @DisplayName("Test update(OrderBook, boolean); given Instrument getSizeFactor() return ten; then calls getAskSize(long)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TAQFormat.update(OrderBook, boolean)"})
   ...
   *   <li>Then calls {@link Instruments#iterator()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TAQFormat#update(OrderBook, boolean)}
   */
   ...
   *   <li>Then calls {@link OrderBook#getInstrument()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TAQFormat#trade(OrderBook, Side, long, long)}
   */
  @Test
  @DisplayName("Test trade(OrderBook, Side, long, long); given Instrument getPriceFactor() return ten; then calls getInstrument()")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test trade(OrderBook, Side, long, long); given Instrument getPriceFactor() return ten; when 'SELL'; then calls getInstrument()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TAQFormat.trade(OrderBook, Side, long, long)"})
