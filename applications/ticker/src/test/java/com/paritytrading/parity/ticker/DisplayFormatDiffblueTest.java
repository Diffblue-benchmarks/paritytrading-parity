...
class DisplayFormatDiffblueTest {
   ...
   * <ul>
   *   <li>Then return timestampMillis is zero.</li>
   * </ul>
   * <p>
   ...
   */
  @Test
  @DisplayName("Test update(OrderBook, boolean); given Instrument getPriceFactor() return ten; then calls getAskSize(long)")
  @Tag("MaintainedByDiffblue")
