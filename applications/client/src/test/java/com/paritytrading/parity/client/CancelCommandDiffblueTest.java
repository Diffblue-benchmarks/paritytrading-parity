...
class CancelCommandDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link CancelCommand}
   */
  @Test
  ...
  /**
   * Test {@link CancelCommand#execute(TerminalClient, Scanner)} with {@code client}, {@code arguments}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test execute(TerminalClient, Scanner) with 'client', 'arguments'; given empty string")
  @Tag("MaintainedByDiffblue")
   ...
   *   <li>When {@link Scanner#Scanner(String)} with {@code foo} useDelimiter {@code foo}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CancelCommand#execute(TerminalClient, Scanner)}
   */
  @Test
  @DisplayName("Test execute(TerminalClient, Scanner) with 'client', 'arguments'; given 'foo'; when Scanner(String) with 'foo' useDelimiter 'foo'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CancelCommand.execute(TerminalClient, Scanner)"})
  void testExecuteWithClientArguments_givenFoo_whenScannerWithFooUseDelimiterFoo() throws IOException {
    // Arrange
    CancelCommand cancelCommand = new CancelCommand();
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String CancelCommand.getDescription()", "String CancelCommand.getName()",
