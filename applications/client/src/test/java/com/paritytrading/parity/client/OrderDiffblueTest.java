...
class OrderDiffblueTest {
   ...
   * <p>
   * Method under test: {@link Order#Order(OrderAccepted)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Order.apply(OrderCanceled)", "void Order.apply(OrderExecuted)", "long Order.getInstrument()",
      "String Order.getOrderId()", "long Order.getQuantity()", "byte Order.getSide()", "long Order.getTimestamp()"})
   ...
   * <ul>
   *   <li>Given {@link Instrument} {@link Instrument#getPriceFormat()} return {@code Price Format}.</li>
   ...
   */
  @Test
  @DisplayName("Test format(Instruments); given Instrument getPriceFormat() return 'Price Format'; then return a string")
  @Tag("MaintainedByDiffblue")
