...
class TradeDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link Trade#Trade(Order, OrderExecuted)}
   */
  @Test
   ...
   * <ul>
   *   <li>Given {@link Event.OrderAccepted#OrderAccepted(OrderAccepted)} with message is {@link POE.OrderAccepted} (default constructor).</li>
   ...
   */
  @Test
  @DisplayName("Test format(Instruments); given OrderAccepted(OrderAccepted) with message is OrderAccepted (default constructor); then return a string")
  @Tag("MaintainedByDiffblue")
