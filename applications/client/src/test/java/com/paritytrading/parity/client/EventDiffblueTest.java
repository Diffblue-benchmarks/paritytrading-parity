...
class EventDiffblueTest {
   ...
   * <p>
   * Method under test: {@link OrderAccepted#OrderAccepted(POE.OrderAccepted)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link OrderCanceled#OrderCanceled(POE.OrderCanceled)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link OrderExecuted#OrderExecuted(POE.OrderExecuted)}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link OrderRejected#OrderRejected(POE.OrderRejected)}
   */
  @Test
