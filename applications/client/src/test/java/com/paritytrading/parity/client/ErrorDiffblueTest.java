...
class ErrorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return format is {@code <unknown>}.
   * </ul>
   *
   * <p>Method under test: {@link Error#Error(Event.OrderRejected)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Given {@link OrderRejected} (default constructor) {@link OrderRejected#reason} is {@code
   *       I}.
   *   <li>Then return {@code Unknown instrument}.
   * </ul>
   *
   * <p>Method under test: {@link Error#format()}
   */
  @Test
  @DisplayName(
      "Test format(); given OrderRejected (default constructor) reason is 'I'; then return 'Unknown instrument'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *   <li>Given {@link OrderRejected} (default constructor) {@link OrderRejected#reason} is {@code
   *       P}.
   *   <li>Then return {@code Invalid price}.
   * </ul>
   *
   * <p>Method under test: {@link Error#format()}
   */
  @Test
  @DisplayName(
      "Test format(); given OrderRejected (default constructor) reason is 'P'; then return 'Invalid price'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.String Error.format()"})
   ...
   *   <li>Given {@link OrderRejected} (default constructor) {@link OrderRejected#reason} is {@code
   *       Q}.
   *   <li>Then return {@code Invalid quantity}.
   * </ul>
   *
   * <p>Method under test: {@link Error#format()}
   */
  @Test
  @DisplayName(
      "Test format(); given OrderRejected (default constructor) reason is 'Q'; then return 'Invalid quantity'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.lang.String Error.format()"})
